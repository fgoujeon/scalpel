...
#include "type_traits/add_unique_ptr.hpp"
...
{
	typedef typename apply_type_trait_to_variadic_template_parameters<type_traits::add_unique_ptr, variant, Ts...>::type type;
};
