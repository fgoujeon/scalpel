...
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(namespace_, operator_function, operator_functions)
...
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, destructor)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, operator_function)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, operator_member_function)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, conversion_function)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, simple_function)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, simple_member_function)
...
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(class_, destructor, get_destructor)
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(class_, operator_function, operator_functions)
GENERATE_EMPTY_GET_MEMBERS_SPECIALIZATION (class_, operator_member_function)
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(class_, conversion_function, conversion_functions)
...
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, destructor)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, operator_function)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, operator_member_function)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, conversion_function)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, simple_function)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, simple_member_function)
...
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, destructor)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, operator_function)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, operator_member_function)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, conversion_function)
...
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, simple_member_function)
