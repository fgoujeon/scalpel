...
#define GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(PARENT_TYPE, MEMBER_TYPE) \
template<> \
get_members_type_traits<semantic_entities::MEMBER_TYPE>::return_type \
get_members<semantic_entities::MEMBER_TYPE, std::shared_ptr<semantic_entities::PARENT_TYPE>>(std::shared_ptr<semantic_entities::PARENT_TYPE> parent) \
{ \
	return get_members<semantic_entities::MEMBER_TYPE>(parent->referred_namespace()); \
}
...
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(namespace_, typedef_, typedefs)
...
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, open_declarative_region_shared_ptr_variant)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, namespace_)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, class_)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, typedef_)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, constructor)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, simple_function)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, variable)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, namespace_alias)
...
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(class_, typedef_, typedefs)
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(class_, constructor, constructors)
...
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, typedef_)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, constructor)
...
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, typedef_)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, constructor)
