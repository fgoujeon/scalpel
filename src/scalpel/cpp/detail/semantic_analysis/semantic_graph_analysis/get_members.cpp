...
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(namespace_, namespace_or_namespace_alias_shared_ptr_variant, namespaces_and_namespace_aliases)
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(namespace_, named_compound_type_shared_ptr_variant, named_compound_types)
...
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, namespace_or_namespace_alias_shared_ptr_variant, namespaces_and_namespace_aliases)
GENERATE_NAMESPACE_ALIAS_GET_MEMBERS_SPECIALIZATION(namespace_alias, named_compound_type_shared_ptr_variant, named_compound_types)
...
GENERATE_EMPTY_GET_MEMBERS_SPECIALIZATION (class_, namespace_or_namespace_alias_shared_ptr_variant)
GENERATE_SIMPLE_GET_MEMBERS_SPECIALIZATION(class_, named_compound_type_shared_ptr_variant, named_compound_types)
...
GENERATE_EMPTY_GET_MEMBERS_SPECIALIZATION (simple_function, namespace_or_namespace_alias_shared_ptr_variant)
GENERATE_EMPTY_GET_MEMBERS_SPECIALIZATION (simple_function, named_compound_type_shared_ptr_variant)
...
GENERATE_EMPTY_GET_MEMBERS_SPECIALIZATION (statement_block, namespace_or_namespace_alias_shared_ptr_variant)
GENERATE_EMPTY_GET_MEMBERS_SPECIALIZATION (statement_block, named_compound_type_shared_ptr_variant)
...
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, namespace_or_namespace_alias_shared_ptr_variant)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(declarative_region_shared_ptr_variant, named_compound_type_shared_ptr_variant)
...
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, namespace_or_namespace_alias_shared_ptr_variant)
GENERATE_DECLARATIVE_REGION_VARIANT_GET_MEMBERS_SPECIALIZATION(open_declarative_region_shared_ptr_variant, named_compound_type_shared_ptr_variant)
