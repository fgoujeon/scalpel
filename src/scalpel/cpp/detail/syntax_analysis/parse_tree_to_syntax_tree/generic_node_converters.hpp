...
SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_NODE_CONVERTER_FROM_ID_SPECIALIZATION(id, return_type, sequence_node<syntax_nodes::return_type>)\
SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_NODE_CONVERTER_FROM_TYPE_SPECIALIZATION(return_type, sequence_node<syntax_nodes::return_type>)\
SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_ID_CHECKER_SPECIALIZATION(id, return_type)

#define SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_ALTERNATIVE_NODE_CONVERTER_SPECIALIZATION(id, return_type)\
SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_NODE_CONVERTER_FROM_ID_SPECIALIZATION(id, return_type, alternative_node<syntax_nodes::return_type>)\
SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_NODE_CONVERTER_FROM_TYPE_SPECIALIZATION(return_type, alternative_node<syntax_nodes::return_type>)\
SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_ID_CHECKER_SPECIALIZATION(id, return_type)
...
SCALPEL_CPP_DETAIL_SYNTAX_ANALYSIS_ALTERNATIVE_NODE_CONVERTER_SPECIALIZATION
(
	BLOCK_DECLARATION,
	block_declaration
)
