...
HAS_MEMBERS_OF_TYPE(namespace_, enum_t)
...
HAS_MEMBERS_OF_TYPE(linked_namespace, enum_t)
...
HAS_MEMBERS_OF_TYPE(unnamed_namespace, enum_t)
...
HAS_MEMBERS_OF_TYPE(linked_unnamed_namespace, enum_t)
...
HAS_MEMBERS_OF_TYPE(class_, member_enum_t)
...
HAS_MEMBERS_OF_TYPE(class_, static_member_variable)
...
HAS_MEMBERS_OF_TYPE(member_class, member_enum_t)
...
HAS_MEMBERS_OF_TYPE(member_class, static_member_variable)
...
HAS_MEMBERS_OF_TYPE(union_, member_enum_t)
...
HAS_MEMBERS_OF_TYPE(member_union, member_enum_t)
...
HAS_MEMBERS_OF_TYPE(anonymous_union, member_enum_t)
...
HAS_MEMBERS_OF_TYPE(anonymous_member_union, member_enum_t)
...
struct has_members_of_type<enum_t, enum_constant<UnderlyingType>>
{
	static const bool value = true;
};

template<typename UnderlyingType>
struct has_members_of_type<member_enum_t, enum_constant<UnderlyingType>>
{
	static const bool value = true;
};
