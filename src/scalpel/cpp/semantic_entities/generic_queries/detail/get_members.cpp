...
GENERATE_GET_MEMBERS_SPECIALIZATION(namespace_, enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(linked_namespace, enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(unnamed_namespace, enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(linked_unnamed_namespace, enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(class_, anonymous_member_union, anonymous_unions)
GENERATE_GET_MEMBERS_SPECIALIZATION(class_, member_enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(member_class, anonymous_member_union, anonymous_unions)
GENERATE_GET_MEMBERS_SPECIALIZATION(member_class, member_enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(union_, anonymous_member_union, anonymous_unions)
GENERATE_GET_MEMBERS_SPECIALIZATION(union_, member_enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(member_union, anonymous_member_union, anonymous_unions)
GENERATE_GET_MEMBERS_SPECIALIZATION(member_union, member_enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(anonymous_union, anonymous_member_union, anonymous_unions)
GENERATE_GET_MEMBERS_SPECIALIZATION(anonymous_union, member_enum_t, enums)
...
GENERATE_GET_MEMBERS_SPECIALIZATION(anonymous_member_union, anonymous_member_union, anonymous_unions)
GENERATE_GET_MEMBERS_SPECIALIZATION(anonymous_member_union, member_enum_t, enums)
