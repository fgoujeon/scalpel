...
GENERATE_GET_MEMBERS_FUNCTION_TEMPLATE(enum_) //implemented in the .ipp file
GENERATE_GET_MEMBERS_FUNCTION_TEMPLATE(member_enum) //implemented in the .ipp file
