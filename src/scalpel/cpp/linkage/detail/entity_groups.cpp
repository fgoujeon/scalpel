...
GENERATE_GET_ENTITY_LIST_SPECIALIZATION(enum_t, enums)
GENERATE_GET_ENTITY_LIST_SPECIALIZATION(member_enum_t, member_enums)
...
INTERNAL_ENTITIES_OF_TYPE(anonymous_union, internal_anonymous_unions)
INTERNAL_ENTITIES_OF_TYPE(anonymous_member_union, internal_anonymous_member_unions)
INTERNAL_ENTITIES_OF_TYPE(enum_t, internal_enums)
INTERNAL_ENTITIES_OF_TYPE(member_enum_t, internal_member_enums)
