...
#include <socoa/cpp/generic_syntax_analyzer.h>
...
(                                                       \
    node,                                               \
    grammar::id,                                        \
    &generic_syntax_analyzer::evaluate_##type           \
)
...
(                                                       \
    node,                                               \
    grammar::id,                                        \
    &generic_syntax_analyzer::evaluate_sequence         \
    <                                                   \
        type,                                           \
        &generic_syntax_analyzer::evaluate_##type,      \
...
generic_syntax_analyzer::generic_syntax_analyzer(const grammar& grammar):
    grammar_(grammar)
{
}

std::shared_ptr<util::sequence<declaration>>
generic_syntax_analyzer::evaluate_file(const tree_node_t& node)
{
        ...
        {
            {
                ...
                <
                    declaration,
                    &generic_syntax_analyzer::evaluate_declaration,
                    util::extern_strings::space
                >
            }
        }
...
generic_syntax_analyzer::evaluate_identifier(const tree_node_t& node)
{
    assert
    (
...
generic_syntax_analyzer::evaluate_id_expression(const tree_node_t& node)
{
    ...
    (
        ...
        {
            {grammar::UNQUALIFIED_ID, &generic_syntax_analyzer::evaluate_unqualified_id},
            {grammar::QUALIFIED_ID, &generic_syntax_analyzer::evaluate_qualified_id}
        }
    );
}

std::shared_ptr<unqualified_id>
generic_syntax_analyzer::evaluate_unqualified_id(const tree_node_t& node)
{
    ...
    (
        ...
        {
//            {grammar::OPERATOR_FUNCTION_ID, &generic_syntax_analyzer::evaluate_identifier},
//            {grammar::CONVERSION_FUNCTION_ID, &generic_syntax_analyzer::evaluate_nested_name_specifier_template_id_part},
//            {grammar::DESTRUCTOR_NAME, &generic_syntax_analyzer::evaluate_nested_name_specifier_template_id_part},
            {grammar::TEMPLATE_ID, &generic_syntax_analyzer::evaluate_template_id},
            {grammar::IDENTIFIER, &generic_syntax_analyzer::evaluate_identifier}
        },
        false
    );
}
...
generic_syntax_analyzer::evaluate_qualified_id(const tree_node_t& node)
{
    ...
    (
        ...
        {
            {grammar::QUALIFIED_NESTED_ID, &generic_syntax_analyzer::evaluate_qualified_nested_id},
            {grammar::QUALIFIED_OPERATOR_FUNCTION_ID, &generic_syntax_analyzer::evaluate_qualified_operator_function_id},
            {grammar::QUALIFIED_TEMPLATE_ID, &generic_syntax_analyzer::evaluate_qualified_template_id},
            {grammar::QUALIFIED_IDENTIFIER, &generic_syntax_analyzer::evaluate_qualified_identifier}
        }
    );
}

std::shared_ptr<qualified_nested_id>
generic_syntax_analyzer::evaluate_qualified_nested_id(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_qualified_operator_function_id(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_qualified_template_id(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_qualified_identifier(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_nested_name_specifier(const tree_node_t& node)
{
    ...
    nested_name_specifier item
    {
        ...
        (
            ...
            {
                {grammar::IDENTIFIER, &generic_syntax_analyzer::evaluate_identifier},
                {grammar::NESTED_NAME_SPECIFIER_TEMPLATE_ID_PART, &generic_syntax_analyzer::evaluate_nested_name_specifier_template_id_part}
            }
        )
    };
...
generic_syntax_analyzer::evaluate_nested_name_specifier_template_id_part(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_declaration(const tree_node_t& node)
{
    ...
    (
        ...
        {
            {grammar::BLOCK_DECLARATION, &generic_syntax_analyzer::evaluate_block_declaration},
            {grammar::FUNCTION_DEFINITION, &generic_syntax_analyzer::evaluate_function_definition},
            {grammar::TEMPLATE_DECLARATION, &generic_syntax_analyzer::evaluate_template_declaration},
//            {grammar::EXPLICIT_INSTANTIATION, &generic_syntax_analyzer::},
//            {grammar::EXPLICIT_SPECIALIZATION, &generic_syntax_analyzer::},
//            {grammar::LINKAGE_SPECIFICATION, &generic_syntax_analyzer::},
            {grammar::NAMESPACE_DEFINITION, &generic_syntax_analyzer::evaluate_namespace_definition}
        },
        false
    );
}
...
std::shared_ptr<declaration>
generic_syntax_analyzer::evaluate_block_declaration(const tree_node_t& node)
{
    ...
    (
        ...
        evaluate_function_typedefs<declaration>::id_function_map_t
        {
            //{grammar::ASM_DEFINITION, &generic_syntax_analyzer::evaluate_block_declaration},
            {grammar::SIMPLE_DECLARATION, &generic_syntax_analyzer::evaluate_simple_declaration},
            //{grammar::NAMESPACE_ALIAS_DEFINITION, &generic_syntax_analyzer::evaluate_template_declaration},
            {grammar::USING_DECLARATION, &generic_syntax_analyzer::evaluate_using_declaration},
            {grammar::USING_DIRECTIVE, &generic_syntax_analyzer::evaluate_using_directive}
        },
        false
    );
}
...
generic_syntax_analyzer::evaluate_simple_declaration(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_decl_specifier(const tree_node_t& node)
{
    ...
    (
        ...
        {
            //{grammar::STORAGE_CLASS_SPECIFIER, &generic_syntax_analyzer::evaluate_block_declaration));
            {grammar::TYPE_SPECIFIER, &generic_syntax_analyzer::evaluate_type_specifier}
            //{grammar::FUNCTION_SPECIFIER, &generic_syntax_analyzer::evaluate_template_declaration));
        },
        false
    );
}
...
generic_syntax_analyzer::evaluate_type_specifier(const tree_node_t& node)
{
    ...
    (
        ...
        {
            {grammar::SIMPLE_TYPE_SPECIFIER, &generic_syntax_analyzer::evaluate_simple_type_specifier},
            {grammar::CLASS_SPECIFIER, &generic_syntax_analyzer::evaluate_class_specifier},
            //{grammar::ENUM_SPECIFIER, &generic_syntax_analyzer::evaluate_template_declaration},
            //{grammar::ELABORATED_TYPE_SPECIFIER, &generic_syntax_analyzer::},
            {grammar::CV_QUALIFIER, &generic_syntax_analyzer::evaluate_cv_qualifier},
            //{grammar::TYPEOF_EXPRESSION, &generic_syntax_analyzer::},,
        },
        false
    );
}
...
generic_syntax_analyzer::evaluate_simple_type_specifier(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_simple_template_type_specifier(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_identifier_or_template_id(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_namespace_definition(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_using_declaration(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_using_directive(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_init_declarator(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_declarator(const tree_node_t& node)
{
        ...
        declarator
        {
            ...
            (
                ...
                (
                    ...
                    &generic_syntax_analyzer::evaluate_ptr_operator
                )
            ),
...
generic_syntax_analyzer::evaluate_direct_declarator(const tree_node_t& node)
{
    ...
    (
        direct_declarator
        {
            ...
            (
                ...
                {
                    {grammar::DIRECT_DECLARATOR_FUNCTION_PART, &generic_syntax_analyzer::evaluate_direct_declarator_function_part},
                    //{grammar::DIRECT_DECLARATOR_ARRAY_PART, &generic_syntax_analyzer::evaluate_direct_declarator_array_part},
                }
            )
        }
    );
...
generic_syntax_analyzer::evaluate_direct_declarator_function_part(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_direct_declarator_array_part(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_ptr_operator(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_cv_qualifier(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_declarator_id(const tree_node_t& node)
{
    ...
    (
        ...
        {
            {grammar::ID_EXPRESSION, &generic_syntax_analyzer::evaluate_id_expression},
            {grammar::NESTED_IDENTIFIER_OR_TEMPLATE_ID, &generic_syntax_analyzer::evaluate_nested_identifier_or_template_id}
        }
    );
}
...
generic_syntax_analyzer::evaluate_parameter_declaration_clause(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_parameter_declaration(const tree_node_t& node)
{
    ...
    <
        decl_specifier,
        &generic_syntax_analyzer::evaluate_decl_specifier,
        util::extern_strings::space
...
generic_syntax_analyzer::evaluate_function_definition(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_class_specifier(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_class_head(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_member_specification(const tree_node_t& node)
{
    ...
    (
        member_specification
        {
            ...
            (
                ...
                {
                    {grammar::MEMBER_DECLARATION, &generic_syntax_analyzer::evaluate_member_declaration},
                    {grammar::MEMBER_SPECIFICATION_ACCESS_SPECIFIER, &generic_syntax_analyzer::evaluate_member_specification_access_specifier}
                }
            )
        }
    );
...
generic_syntax_analyzer::evaluate_member_specification_access_specifier(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_member_declaration(const tree_node_t& node)
{
    ...
    (
        ...
        {
            {grammar::MEMBER_DECLARATION_MEMBER_DECLARATOR_LIST, &generic_syntax_analyzer::evaluate_member_declaration_member_declarator_list},
            {grammar::MEMBER_DECLARATION_UNQUALIFIED_ID, &generic_syntax_analyzer::evaluate_member_declaration_unqualified_id},
            {grammar::MEMBER_DECLARATION_FUNCTION_DEFINITION, &generic_syntax_analyzer::evaluate_member_declaration_function_definition},
            {grammar::USING_DECLARATION, &generic_syntax_analyzer::evaluate_using_declaration},
            {grammar::TEMPLATE_DECLARATION, &generic_syntax_analyzer::evaluate_template_declaration}
        }
    );
...
generic_syntax_analyzer::evaluate_member_declaration_member_declarator_list(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_member_declaration_unqualified_id(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_member_declaration_function_definition(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_member_declarator(const tree_node_t& node)
{
    ...
    (
        ...
        {
            {grammar::MEMBER_DECLARATOR_DECLARATOR, &generic_syntax_analyzer::evaluate_member_declarator_declarator},
            {grammar::MEMBER_DECLARATOR_BIT_FIELD_MEMBER, &generic_syntax_analyzer::evaluate_member_declarator_bit_field_member}
        }
    );
}

std::shared_ptr<member_declarator_declarator>
generic_syntax_analyzer::evaluate_member_declarator_declarator(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_member_declarator_bit_field_member(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_base_clause(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_base_specifier(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_ctor_initializer(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_mem_initializer(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_mem_initializer_id(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_template_declaration(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_template_id(const tree_node_t& node)
{
...
generic_syntax_analyzer::evaluate_template_argument(const tree_node_t& node)
{
    ...
    (
        ...
        {
            //{grammar::TEMPLATE_ARGUMENT_ASSIGNMENT_EXPRESSION, &generic_syntax_analyzer::evaluate_assignment_expression},
            //{grammar::TYPE_ID, &generic_syntax_analyzer::evaluate_type_id},
            {grammar::ID_EXPRESSION, &generic_syntax_analyzer::evaluate_id_expression}
        },
        false
    );
...
generic_syntax_analyzer::evaluate_nested_identifier_or_template_id(const tree_node_t& node)
{
...
const generic_syntax_analyzer::tree_node_t*
generic_syntax_analyzer::find_child_node(const tree_node_t& parent_node, grammar::parser_id child_id)
{
...
bool
generic_syntax_analyzer::check_node_existence(const tree_node_t& parent_node, const std::string& value, unsigned int position)
{
...
bool
generic_syntax_analyzer::check_node_existence(const tree_node_t& parent_node, const std::string& value)
{
    for(tree_node_iterator_t i = parent_node.children.begin(); i != parent_node.children.end(); ++i) //for each child
    {
        const tree_node_t& child_node = *i;
...
bool
generic_syntax_analyzer::check_node_existence
(
...
std::string
generic_syntax_analyzer::get_only_child_value(const tree_node_t& node)
{
    assert(node.children.size() == 1);
...
std::string
generic_syntax_analyzer::get_value(const tree_node_t& node)
{
    //get value
...
std::string
generic_syntax_analyzer::strip_redundant_spaces(const std::string& str)
{
    std::string result;
...
int
generic_syntax_analyzer::get_id(const tree_node_t& node)
{
