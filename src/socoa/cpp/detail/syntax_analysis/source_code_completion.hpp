...
namespace socoa { namespace cpp { namespace detail { namespace syntax_analysis { namespace source_code_completion
{
...
}}}}} //namespace socoa::cpp::detail::syntax_analysis::source_code_completion
