...
#ifndef SOCOA_CPP_PARSE_TREE_TO_SYNTAX_TREE_CONVERT_FUNCTION_CALLERS_H
#define SOCOA_CPP_PARSE_TREE_TO_SYNTAX_TREE_CONVERT_FUNCTION_CALLERS_H
...
#include "special_convert_functions_fwd.h"
