...
syntax_analyzer::operator()(const std::string& input)
{
    ...
    return evaluate_file(root_node);
}

std::shared_ptr<util::sequence<declaration>>
syntax_analyzer::evaluate_file(const tree_node_t& node)
{
...
syntax_analyzer::evaluate_simple_type_specifier(const tree_node_t& node)
{
    ...
    (
        ...
        evaluate_function_typedefs<simple_type_specifier>::id_function_map_t
        {
            ...
            {grammar::BUILT_IN_TYPE_SPECIFIER, &syntax_analyzer::evaluate_string_enumeration<built_in_type_specifier>}
        }
    );
}
...
syntax_analyzer::evaluate_base_clause(const tree_node_t& node)
{
...
syntax_analyzer::evaluate_base_specifier(const tree_node_t& node)
{
...
syntax_analyzer::find_child_node(const tree_node_t& parent_node, grammar::parser_id child_id)
{
...
bool
syntax_analyzer::check_node_existence
(
