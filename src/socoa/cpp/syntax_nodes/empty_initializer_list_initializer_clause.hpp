...
#ifndef SOCOA_CPP_SYNTAX_NODES_EMPTY_INITIALIZER_LIST_INITIALIZER_CLAUSE_HPP
#define SOCOA_CPP_SYNTAX_NODES_EMPTY_INITIALIZER_LIST_INITIALIZER_CLAUSE_HPP
