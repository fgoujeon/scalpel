...
GET_TYPE_SPECIALIZATION(assignment_assignment_expression)
...
GET_TYPE_SPECIALIZATION(template_argument_assignment_assignment_expression)
...
GET_TYPE_SPECIALIZATION(unary_operator_expression)
